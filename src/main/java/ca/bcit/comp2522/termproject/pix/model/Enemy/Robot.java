...
public class Robot extends Minion {
    ...
    private static final int MOVING_FRAME = 18;
    private static final int HURTING_DURATION = 100;
    private static final int HURTING_FRAME = 12;
    private static final int ATTACKING_DURATION = 100;
    private static final int ATTACKING_FRAME = 13;
    private static final int DYING_DURATION = 50;
    private static final int DYING_FRAME = 16;
     ...
     */
    public Robot(final int x, final int y, final boolean moveOnXAxis) {
        super(x - WIDTHS, y - HEIGHTS, WIDTHS, HEIGHTS, EnemyType.ROBOT, MOVING_RANGE, MOVING_DURATION,
