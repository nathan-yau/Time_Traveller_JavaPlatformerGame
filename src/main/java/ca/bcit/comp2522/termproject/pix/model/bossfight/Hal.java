...
public class Hal extends Boss {
    ...
    private static final int X_OFFSET = 780;
    private static final int Y_OFFSET = 620;
    ...
    public Hal(final int x, final int y) {
        super(INITIAL_HEALTH_POINTS, X_OFFSET, Y_OFFSET, WIDTH, HEIGHT, EnemyType.HAL, ATTACK_POINT);
    }
}
