...
public class Knight extends Minion {
    ...
    private static final int MOVING_DURATION = 230;
    private static final int MOVING_FRAME = 6;
    private static final int HURTING_DURATION = 100;
    private static final int HURTING_FRAME = 4;
    private static final int ATTACKING_DURATION = 100;
    private static final int ATTACKING_FRAME = 6;
    private static final int DYING_DURATION = 50;
    private static final int DYING_FRAME = 8;
     ...
     */
    public Knight(final int x, final int y, final boolean moveOnXAxis) {
        super(x - WIDTHS, y - HEIGHTS, WIDTHS, HEIGHTS, EnemyType.KNIGHT, MOVING_RANGE, MOVING_DURATION,
